...
<body>
    <div class="d-flex justify-center flex-column mb-3 mt-2 align-items-center">
        ...
        <div>
            ...
            <a href="<?=URL?>/usuarios/cadastrar"><button type="button" class="btn btn-primary">Cadastrar Usuário <i class="bi bi-person-plus-fill"></i></button></a> 
        </div>
    </div>

    <div class="container border border-1 p-2">
        <form method="POST" name="cadastrar" action="<?=URL?>/usuarios/alterar/<?=$dados['id']?>">
